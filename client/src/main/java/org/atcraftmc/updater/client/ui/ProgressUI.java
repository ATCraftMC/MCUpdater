...
public class ProgressUI implements UpdateOperationListener {
    private JPanel root;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public ProgressUI(BiConsumer<UpdateOperationListener, JFrame> action, JFrame container) {
        new Thread(() -> action.accept(this, container)).start();
        container.dispose();
    }

    public static void open(String title, BiConsumer<UpdateOperationListener, JFrame> action) {
        var frame = new JFrame(title);
        frame.setContentPane(new ProgressUI(action, frame).root);
    ...
    private Font $$$getFont$$$(String fontName, int style, int size, Font currentFont) {
        ...
        Font fontWithFallback = isMac ? new Font(font.getFamily(), font.getStyle(), font.getSize()) : new StyleContext().getFont(
                font.getFamily(),
                font.getStyle(),
                font.getSize()
        );
