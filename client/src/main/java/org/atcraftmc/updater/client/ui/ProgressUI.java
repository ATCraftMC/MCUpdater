...
public class ProgressUI extends UI<ProgressUI> implements UpdateOperationListener {
    private final Consumer<UIHandle<ProgressUI>> action;
    private JPanel root;
    private JProgressBar progress;
    private JLabel operation;

    public ProgressUI(Consumer<UIHandle<ProgressUI>> action) {
        this.action = action;
    }

    public static UIHandle<ProgressUI> open(Consumer<UIHandle<ProgressUI>> action) {
        return new UIHandle<>("MC-Updater", new ProgressUI(action));
    }

    @Override
    public void setup(UIHandle<ProgressUI> handle) {
