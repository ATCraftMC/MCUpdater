...
public final class P55_CDNFileChangeReady implements Packet {
    private final String repo;
    private final String token;
    private final Set<String> targets;

    public P55_CDNFileChangeReady(String repo, String token, Set<String> targets) {
        this.repo = repo;
        this.token = token;
    ...
    public P55_CDNFileChangeReady(ByteBuf buffer) {
